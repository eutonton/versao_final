...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="#" class="btn" style="margin-top: 0;">Publique uma Vaga</a>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <div class="user">
            ...
            <div>
               <h3>João guilherme Wanderley</h3>
               <span>Head front-end</span>
            </div>
         </div>
      </div>
      ...
      <div class="box">
         ...
         <div class="user">
            ...
            <div>
               <h3>Wellington Araujo</h3>
               <span>back-end jr</span>
            </div>
         </div>
      </div>
