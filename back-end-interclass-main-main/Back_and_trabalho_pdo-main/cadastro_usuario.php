...
body {
  ...
  background: linear-gradient(135deg, #124559, transparent), url(./desgin/images/homefoto.png);
	height: 100vh;
	background-size: cover;
...
<header>
  ...
  <div class="wrapper row">
    ...
    <a class="logo" href="index.php"><img style="width: 150px;" src="./desgin/images/logo__1_-removebg-preview.png" alt="logo"></a>
    <nav class="nav">
      <ul>
